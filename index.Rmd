...
$$
\begin{align*}
y_{ib} & \sim \color{red}{\operatorname{N}(z_{ib}, \sigma^2_{ib}).}  \\
y_{id} & \sim \color{red}{\operatorname{N}(z_{id}, \sigma^2_{id}).}
\end{align*}
$$
...
<!-- $$ -->
<!-- \begin{align*} -->
<!-- z_{ib} \sim \sum_{k=1}^K p_{bk} \operatorname{N}(\mu_k, \sigma^2_k). -->
<!-- \end{align*} -->
<!-- $$ -->
...
$$
\begin{align*}
{z}_{ib} \sim \color{blue}{\sum_{k=1}^K p_{bk} \operatorname{N}(\mu_k, \sigma^2_k).}
\end{align*}
$$
...
$$
\begin{align*}
z_{id} & \sim \color{blue}{\sum_{b=1}^B \phi_b \sum_{k=1}^K p_{bk} \operatorname{N}(\mu_k, \sigma^2_k).}
\end{align*}
$$
...
$$
\begin{align*}
z_{id} & \sim \color{blue}{\sum_{b=1}^B \phi_{db} \sum_{k=1}^K p_{bk} \operatorname{N}(\mu_k, \sigma^2_k).}
\end{align*}
$$
...
<font size="+6">\color{blue}jrtipton@uark.edu</font>
